...
# --- НАСТРОЙКИ БОТА ---
API_TOKEN = '7675571104:AAH3ZJ7x62mCc9AB90Y_Hv_uJmPF-bznW5E'
...
LANGS = {
    'ru': {
        ...
        'check_sub': "✅ Проверить", 'sub_err': "❌ Вы не подписались! Подпишитесь, чтобы начать зарабатывать.", 'sub_ok': "🎉 Отлично! Вам начислено бонусное вознаждение.", 'unsub_pen': "<blockquote>⚠️ <b>Штраф!</b></blockquote>\n<i>Вы отписались от канала-спонсора.</i>\nС баланса списано 0.01 USDT. Подпишитесь снова!",
        ...
        'with_max_btn': "💰 Вывести всё (MAX)", 'with_man_btn': "✍️ Ввести сумму вручную", 'withdraw_req': "<blockquote>💰 <i>Введите сумму для вывода вручную (Мин. 0.11 USDT):</i></blockquote>\nИли выберите действие в меню для отмены.", 'with_err_num': "❌ Введите корректное число!", 'with_err_min': "❌ Минимальная сумма вывода 0.11 USDT", 'with_err_bal': "❌ Недостаточно средств на балансе!", 'with_ok': "✅ Заявка создана! Ожидайте чек.",
    ...
    'de': {
        ...
        'rules': "<blockquote>📜 <b>REGELN:</b></blockquote>\n1️⃣ Min. Auszahlung: 0.11 USDT.\n2️⃣ Strafen für Entabonnieren!\n3️⃣ Ränge: Bronze, Silber, Gold, Platin.\n4️⃣ Referrals: 0.03 USDT für aktive Freunde.", 'info': "<blockquote>🏢 <b>ÜBER UNS:</b></blockquote>\nWir are NM Global Technologies.", 'tech_sup_btn': "👨‍💻 Support", 'all_tasks': "<blockquote>📋 <b>Verfügbare Aufgaben:</b></blockquote>",
        'withdraw_menu': "<blockquote>💸 <b>AUSZAHLUNG</b></blockquote>\n💎 <i>Verfügbar:</i> <code>{bal} USDT</code>", 'with_max_btn': "💰 Alles auszahlen (MAX)", 'with_man_btn': "✍️ Betrag manuell eingeben", 'withdraw_req': "<blockquote>💰 <i>Betrag eingeben (Min. 0.11 USDT):</i></blockquote>", 'with_err_num': "❌ Ungültige Zahl!", 'with_err_min': "❌ Minimum ist 0.11 USDT", 'with_err_bal': "❌ Unzureichendes Guthaben!", 'with_ok': "✅ Anfrage erstellt!",
    ...
    'uk': {
        ...
        'rules': "<blockquote>📜 <b>ПРАВИЛА:</b></blockquote>\n1️⃣ Мін. виведення: 0.11 USDT.\n2️⃣ Штраби за відписку!\n3️⃣ Ранги: Бронза, Сільвер, Золото, Платина.\n4️⃣ Реферали: 0.03 USDT за активних друзів.", 'info': "<blockquote>🏢 <b>ПРО КОМПАНІЮ:</b></blockquote>\nБот розроблений NM Global Technologies.", 'tech_sup_btn': "👨‍💻 Підтримка", 'all_tasks': "<blockquote>📋 <b>Доступні завдання:</b></blockquote>",
        'withdraw_menu': "<blockquote>💸 <b>УПРАВЛЕНИЕ БАЛАНСОМ</b></blockquote>\n💎 <i>Доступно:</i> <code>{bal} USDT</code>", 'with_max_btn': "💰 Вивести все (MAX)", 'with_man_btn': "✍️ Ввести суму вручну", 'withdraw_req': "<blockquote>💰 <i>Введіть суму (Мін. 0.11 USDT):</i></blockquote>", 'with_err_num': "❌ Некоректне число!", 'with_err_min': "❌ Мінімум 0.11 USDT", 'with_err_bal': "❌ Недостатньо коштів!", 'with_ok': "✅ Заявку створено!",
